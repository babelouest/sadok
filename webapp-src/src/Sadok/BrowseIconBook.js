...
export default function BrowseIconBook({book, cbOpenBook, cbOpenBookDir, cbViewBook}) {
  return (
    <div className="col-lg-2 col-md-4 col-sm-6 col-xs-12">
      <div className="card">
        ...
        <BrowseIconBookMetadata book={book} cbOpenBookDir={cbOpenBookDir} cbViewBook={cbViewBook} />
      </div>
    </div>
  );
}
